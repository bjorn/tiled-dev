...
*   Added button to toggle Terrain Brush to full tile mode (by Finlay Pearson, [#3407](https://github.com/mapeditor/tiled/issues/3407))
*   Added square selection and expand-from-center to Rectangular Select tool ([#4201](https://github.com/mapeditor/tiled/pull/4201))
*   Added status info for various Stamp Brush, Terrain Brush and Eraser modes ([#3092](https://github.com/mapeditor/tiled/issues/3092), [#4201](https://github.com/mapeditor/tiled/pull/4201))
*   Added Escape to clear tile selection when any tile related tool is selected ([#4243](https://github.com/mapeditor/tiled/pull/4243))
...
*   Adjust world map position when resizing a map with offset ([#4270](https://github.com/mapeditor/tiled/pull/4270))
...
*   Added Delete shortcut to Remove Tiles action by default and avoid ambiguity ([#4201](https://github.com/mapeditor/tiled/pull/4201))
...
*   Scripting: Added API for custom property types (with dogboydog, [#3971](https://github.com/mapeditor/tiled/issues/3971))
...
[Tiled 1.11]: https://www.mapeditor.org/2024/06/27/tiled-1-11-released.html
